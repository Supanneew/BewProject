...
import 'package:enetb/screens/loadpdf.dart';
import 'package:enetb/screens/show_load_pdf.dart';
import 'package:flutter/material.dart';

String fontFam = 'Quark';

class DetailLoadA extends StatefulWidget {
  final int index;

  DetailLoadA({Key key, this.index}) : super(key: key);

  @override
  _DetailLoadState createState() => _DetailLoadState();
}

class _DetailLoadState extends State<DetailLoadA> {
//  Field
  int index;
    ...
    return Scaffold(
      ...
      body: loadModels.length == 0
        ...
        itemBuilder: (value, index) => GestureDetector(
          onTap: () {
            MaterialPageRoute route = MaterialPageRoute(builder: (value)=>LoadPdf(loadModel: loadModels[index],));
